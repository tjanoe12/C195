package Controller;
/**
 * Add customer controller for adding customers to the MySQL database, uses the CustomerDB class for data exchange to DB
 */
...
public class AddCustomer implements Initializable {
     ...
     * Within each combobox a for each lambda loop will run reducing the amount of code to iterate through objects
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            ...
            createdByTxt.setText(String.valueOf(User.getUsername()));
            lastUpdatedByTxt.setText(String.valueOf(User.getUsername()));
            try {
