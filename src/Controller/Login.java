package Controller;
/**
 * Main log in verifying the user exists in the DB
 * It is pulling the attemps and logging them to login_activity.txt via the UserDB class.
 * The username is captured and used to auto fill the created by and last updated by fields on adding an appointment or customer.
 */
